        ...
        <main>
            ...
            <div class="main-div-1-weopan">
                ...
                <div class="main-div-1-pokypka">
                    <img src="img/товары/<?= $product['IMG']?>" alt="<?=$product['Title']?>" class="oryshie-img card-item" width="350px" height="175px">
                    ...
                    <?php if ($_SESSION['user']['Post'] == 'Админ'):?>
                        <div class="main-info-pokypka-1">
                            <p class="info-pokypka-1">Осталось: <?= $product['Est_colvo']?></p>
                            <p class="info-pokypka-1">Купили: <?= $product['Buy_colvo']?></p>
                        </div>
                    <?php else:?>
                    <?php endif;?>
                    <?php if (!empty($_SESSION['user'])):?>
