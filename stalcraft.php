...
<html lang="RU">
  ...
  <div class="header-button">
    ...
    <div class="header-button">
        ...
        <main>
            <h2 style="margin-bottom:10px">STALCRAFT</h2>
            <p class="main-div-3-text-1">STALCRAFT - массовая многопользовательская онлайн-игра в жанре MMOFPS<br>
            с элементами Survival Horror. Сочетает в себе открытый мир, элементы RPG<br> 
            и динамичную шутерную составляющую. Большую часть времени игрок проводит<br> 
            в открытом мирe. Чернобыльской Зоны Отчуждения.</p>
            ...
            <div class="main-div-3-main">
                <div class="main-div-3-info">
                    <div class="main-div-3-block" style="border:none">
                        <img src="img/div1.png" alt="" width="338px" height="507px" class="main-info-img">
                        <h3>Самые топовые оружия на сервере</h3>
                        <p class="main-div-3-text-2">Мы предоставляем оружия, которые на данный<br> момент 
                            в ходят топ 10 самый часто покупаемых на сервере.
                        </p>
                        <a href="weopan.php" class="knopka-1-header">Оружие</a>
                    </div>
                    <div class="main-div-3-block" style="border:none">
                        <img src="img/div2.png" alt="" width="338px" height="507px" class="main-info-img">
                        <h3>Самые топовые броники на сервере</h3>
                        <p class="main-div-3-text-2">Мы предоставляем броники, которые на данный<br> момент
                            в ходят топ 10 самый часто покупаемых на сервере.
                        </p>
                        <a href="brony.php" class="knopka-1-header">Броня</a>
                    </div>
                    <div class="main-div-3-block" style="border:none">
                        <img src="img/div3.png" alt="" width="338px" height="507px" class="main-info-img">
                        <h3>Продажу внутриигровой валюты.</h3>
                        <p class="main-div-3-text-2">Мы предоставляем внутриигровую валюту, которая<br>  на
                            сервере очень сильно нужна для удобной и приятной игры.
                        </p>
                        <a href="money.php" class="knopka-2-header">Игровая валюта</a>
                    </div>
                </div>
            </div>
        </main>
